...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-room" data-rule="required" class="form-control selectpicker" name="row[room]">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-saloon" data-rule="required" class="form-control selectpicker" name="row[saloon]">
                <?php if(is_array($saloonList) || $saloonList instanceof \think\Collection || $saloonList instanceof \think\Paginator): if( count($saloonList)==0 ) : echo "" ;else: foreach($saloonList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',""))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-toilet" data-rule="required" class="form-control selectpicker" name="row[toilet]">
                <?php if(is_array($toiletList) || $toiletList instanceof \think\Collection || $toiletList instanceof \think\Paginator): if( count($toiletList)==0 ) : echo "" ;else: foreach($toiletList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',""))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
