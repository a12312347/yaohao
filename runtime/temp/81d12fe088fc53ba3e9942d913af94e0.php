...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-alias" data-rule="required" class="form-control" name="row[alias]" type="text" value="<?php echo htmlentities($row['alias']); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-detail_img" data-rule="required" class="form-control" size="50" name="row[detail_img]" type="text" value="<?php echo htmlentities($row['detail_img']); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-thumbnail_img" data-rule="required" class="form-control" size="50" name="row[thumbnail_img]" type="text" value="<?php echo htmlentities($row['thumbnail_img']); ?>">
                <div class="input-group-addon no-border no-padding">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-renovation" data-rule="required" class="form-control selectpicker" name="row[renovation]">
                <?php if(is_array($renovationList) || $renovationList instanceof \think\Collection || $renovationList instanceof \think\Paginator): if( count($renovationList)==0 ) : echo "" ;else: foreach($renovationList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['renovation'])?$row['renovation']:explode(',',$row['renovation']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-class" data-rule="required" class="form-control selectpicker" name="row[class]">
                <?php if(is_array($classList) || $classList instanceof \think\Collection || $classList instanceof \think\Paginator): if( count($classList)==0 ) : echo "" ;else: foreach($classList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['class'])?$row['class']:explode(',',$row['class']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-sale" data-rule="required" class="form-control selectpicker" name="row[sale]">
                <?php if(is_array($saleList) || $saleList instanceof \think\Collection || $saleList instanceof \think\Paginator): if( count($saleList)==0 ) : echo "" ;else: foreach($saleList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['sale'])?$row['sale']:explode(',',$row['sale']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-house_price" data-rule="required" class="form-control" step="0.01" name="row[house_price]" type="number" value="<?php echo htmlentities($row['house_price']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Total_price'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-total_price" data-rule="required" class="form-control" step="0.01" name="row[total_price]" type="number" value="<?php echo htmlentities($row['total_price']); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-is_hot" data-rule="required" class="form-control selectpicker" name="row[is_hot]">
                <?php if(is_array($isHotList) || $isHotList instanceof \think\Collection || $isHotList instanceof \think\Paginator): if( count($isHotList)==0 ) : echo "" ;else: foreach($isHotList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['is_hot'])?$row['is_hot']:explode(',',$row['is_hot']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-address" data-rule="required" data-toggle="addresspicker" data-input-id="c-address" data-lng-id="c-longitude" data-lat-id="c-latitude" class="form-control" name="row[address]" type="text" value="<?php echo htmlentities($row['address']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Longitude'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-longitude" data-rule="required" class="form-control" name="row[longitude]" type="text" value="<?php echo htmlentities($row['longitude']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Latitude'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-latitude" data-rule="required" class="form-control" name="row[latitude]" type="text" value="<?php echo htmlentities($row['latitude']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Developer'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-developer" class="form-control" name="row[developer]" type="text" value="<?php echo htmlentities($row['developer']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Use_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-use_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[use_time]" type="text" value="<?php echo $row['use_time']?datetime($row['use_time']):''; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Green'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-green" class="form-control" step="0.01" name="row[green]" type="number" value="<?php echo htmlentities($row['green']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Volume'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-volume" class="form-control" step="0.01" name="row[volume]" type="number" value="<?php echo htmlentities($row['volume']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Parking'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-parking" class="form-control" name="row[parking]" type="number" value="<?php echo htmlentities($row['parking']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Traffic'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-traffic" class="form-control" name="row[traffic]" type="text" value="<?php echo htmlentities($row['traffic']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Addr_area'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-addr_area" class="form-control" step="0.01" name="row[addr_area]" type="number" value="<?php echo htmlentities($row['addr_area']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Buld_area'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-buld_area" class="form-control" step="0.01" name="row[buld_area]" type="number" value="<?php echo htmlentities($row['buld_area']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Complete_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-complete_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[complete_time]" type="text" value="<?php echo $row['complete_time']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Building'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-building" class="form-control" name="row[building]" type="number" value="<?php echo htmlentities($row['building']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Householder'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-householder" class="form-control" name="row[householder]" type="number" value="<?php echo htmlentities($row['householder']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Floor'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-floor" class="form-control" name="row[floor]" type="number" value="<?php echo htmlentities($row['floor']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Property'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-property" class="form-control" name="row[property]" type="text" value="<?php echo htmlentities($row['property']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Synopsis'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-synopsis" class="form-control " rows="5" name="row[synopsis]" cols="50"><?php echo htmlentities($row['synopsis']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-is_user" data-rule="required" class="form-control selectpicker" name="row[is_user]">
                <?php if(is_array($isUserList) || $isUserList instanceof \think\Collection || $isUserList instanceof \think\Paginator): if( count($isUserList)==0 ) : echo "" ;else: foreach($isUserList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['is_user'])?$row['is_user']:explode(',',$row['is_user']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-real_images" data-rule="required" class="form-control" size="50" name="row[real_images]" type="text" value="<?php echo htmlentities($row['real_images']); ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-periphery_images" data-rule="required" class="form-control" size="50" name="row[periphery_images]" type="text" value="<?php echo htmlentities($row['periphery_images']); ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-template_images" data-rule="required" class="form-control" size="50" name="row[template_images]" type="text" value="<?php echo htmlentities($row['template_images']); ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-effect_images" data-rule="required" class="form-control" size="50" name="row[effect_images]" type="text" value="<?php echo htmlentities($row['effect_images']); ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-bird_images" data-rule="required" class="form-control" size="50" name="row[bird_images]" type="text" value="<?php echo htmlentities($row['bird_images']); ?>">
                <div class="input-group-addon no-border no-padding">
