...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-questions_id" data-rule="required" data-source="questions/index" class="form-control selectpage" name="row[questions_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Answers_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-answers_id" data-rule="required" data-source="answers/index" class="form-control selectpage" name="row[answers_id]" type="text" value="">
        </div>
    </div>
