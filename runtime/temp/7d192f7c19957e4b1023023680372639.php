...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-building_id" data-rule="required" data-source="building/index" data-primary-key="building_id" class="form-control selectpage" name="row[building_id]" type="text" value="<?php echo htmlentities($row['building_id']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Tung'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-tung" data-rule="required" class="form-control" name="row[tung]" type="number" value="<?php echo htmlentities($row['tung']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Unit'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-unit" data-rule="required" class="form-control" name="row[unit]" type="number" value="<?php echo htmlentities($row['unit']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Floor'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-floor" data-rule="required" class="form-control" name="row[floor]" type="number" value="<?php echo htmlentities($row['floor']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-room" data-rule="required" class="form-control" name="row[room]" type="number" value="<?php echo htmlentities($row['room']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Saloon'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-saloon" data-rule="required" class="form-control" name="row[saloon]" type="number" value="<?php echo htmlentities($row['saloon']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Toilet'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-toilet" data-rule="required" class="form-control" name="row[toilet]" type="number" value="<?php echo htmlentities($row['toilet']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Balcony'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-balcony" data-rule="required" class="form-control" name="row[balcony]" type="number" value="<?php echo htmlentities($row['balcony']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Area'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-area" data-rule="required" class="form-control" step="0.01" name="row[area]" type="number" value="<?php echo htmlentities($row['area']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-three_price" data-rule="required" class="form-control" step="0.01" name="row[three_price]" type="number" value="<?php echo htmlentities($row['three_price']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Six_price'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-six_price" data-rule="required" class="form-control" step="0.01" name="row[six_price]" type="number" value="<?php echo htmlentities($row['six_price']); ?>">
        </div>
    </div>
